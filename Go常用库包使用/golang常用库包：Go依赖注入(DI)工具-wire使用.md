...
![go-packages-di-wire-basic-demo](../images/go-packages-di-wire-basic-demo.png)
...
---
也可以到我的公众号 **九卷沉思录**：[golang常用库包：Go依赖注入(DI)工具-wire使用](https://mp.weixin.qq.com/s/O4KX9rrKl_QmX2kWYJKYaQ) 讨论
